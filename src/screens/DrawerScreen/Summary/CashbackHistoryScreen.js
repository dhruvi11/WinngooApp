...
const CashbackHistoryScreen = ({ navigation }) => {
  ...
  // UseEffect ======================================================================================
  useEffect(async () => {
   cashbackHistoryApiCall();
  }, [cashbackHistoryApiCall]);
  // ==========================================Api Call================
  const cashbackHistoryApiCall = async () => {
        ...
        <View style={{ flexDirection: "row", width: "100%" }}>
          <View style={{ width: "80%" }}>
            <View style={{ flexDirection: "row" }}>
              <Text style={[styles.headerText, { width: responsiveScreenWidth(30), }]}>Description:</Text>
