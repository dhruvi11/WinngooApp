    ...
    return (
      <View style={styles.personalView}>
        <View style={styles.rowView}>
          ...
          <Text style={styles.blackSmallText}>{data.card_holder_name}</Text>
        </View>
        <View style={styles.rowView}>
          <Text style={styles.blackSmallText}>Card Number:  </Text>
          <Text style={styles.blackSmallText}>{data.card_number}</Text>
        </View>
        <View style={styles.rowView}>
          <Text style={styles.blackSmallText}>Issue Date:  </Text>
          <Text style={styles.blackSmallText}>{data.issue_date}</Text>
        </View>
        <View style={styles.rowView}>
          <Text style={styles.blackSmallText}>Expirt Date:  </Text>
          <Text style={styles.blackSmallText}>{data.expiry_date}</Text>
        </View>
      </View>
    );
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.container}>
        <TopHeaderView
          ...
          headerText={"WinngooApp Card Detail"}
        />
