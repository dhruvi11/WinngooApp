            ...
            <View style={styles.mainview}>
              ...
              <TouchableOpacity
                style={[
                  ...
                  { flexDirection: "row", height: responsiveScreenWidth(10),alignItem:"center",padding:5 },
                ]}
                onPress={() => {
                  selectFile();
                }}
              >
                <Image
                  ...
                  style={{ height: 20, width: 20, alignSelf: "center",marginStart:10}}
                ></Image>

                <Text
                  style={[styles.modaltextStyle1, { colors: colors.BLUETEXT ,alignSelf:"center",marginStart:15}]}
                >
                  Select Image
                </Text>
              </TouchableOpacity>
